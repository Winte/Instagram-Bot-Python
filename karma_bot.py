...
class InstaCommentBot:
    ...
    hashtags = [
        'holiday', 'holidays', 'instatravel', 'wanderlust', 'travels', 'travel', 'trip', 'explore', 'exploring', 'vacation', 'adventure',  'flying', 'viaggiare',
    ]
    ...
    def finalize(self):
        print ("If we consider the karma it's as if you had given $" + string(self.price) + " back to the community.")
        self.browser.close()
        sys.exit()

comBot = InstaCommentBot()
